...
export const getMainImagesFromFolder = (folderName) => {
  ...
  const thumbnailTeste = new URL(`/src/assets/imgs/projeto10/thumbnail.jpg`, import.meta.url).href;

  console.log("🚀 ~ getMainImagesFromFolder ~ thumbnailTeste:", thumbnailTeste)
