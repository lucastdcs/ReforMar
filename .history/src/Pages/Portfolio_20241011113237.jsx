...
const Portfolio = () => {
  ...
  const getProjects = () => {
    const allProjects = [];
    let i = 0;  // Não sabemos o limite, começamos com 0
    ...
    while (true) {
      try {
        ...
        // Se a pasta/arquivo for encontrado, adicione ao array
        allProjects.push({
          imageUrls,
          thumbnailUrl,
          beforeAndAfter,
        ...
        // Se um erro acontecer, assumimos que os projetos acabaram
        console.log(`Nenhum projeto encontrado em projeto${i}, parando a busca.`);
        break;
      }
      
      i++; // Incrementa para o próximo projeto
    }
