...
import { getBeforeAfterImagesFromFolder, getThumbnailFromFolder, getImagesFromFolder } from "../utils/getImagesfromFolder.js";
...
const Portfolio = () => {
  ...
  const getProjects = () => {
    ...
    while (i < 20) {
      ...
      const thumbnailUrl = getThumbnailFromFolder(`projeto${i}`);
      ...
      if (imageUrls === undefined || beforeAndAfter === undefined || thumbnailUrl === undefined) {
        console.log(
          `Nenhum projeto encontrado em projeto${i}, parando a busca.`
        );
        break;
      }
